...
I ran and debugged the Adroid app on an Android 7 (API 25) VM (qemu, Android SDK default) and a Moto X device with Android 6 (API 23). For iOS app I used the simulator with iPhone 5s and iOS 10.3 on Mac. Unfortunatelly I had no chance to test on iPhone device.
